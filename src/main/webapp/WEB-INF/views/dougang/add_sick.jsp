...
%>
<body>
	<h1 align="center">新增住院页</h1>
	<div style="margin-left: auto; margin-right: auto; width: 800px">
		<form action="<%=basePath%>/addSick.do" method="post"
			id="fund_edit_form">
			...
			<table class="tbDetail" cellspacing="0" cellpadding="2"
				...
				<tr>
					...
					<td width="60%"><input style="width: 100%; height: 100%"
						type="text" name="beginTime" value="${bean.beginTime }" 
						onfocus="WdatePicker({el:this,dateFmt:'yyyy-MM-dd'})"/></td>
				</tr>
				<tr>
					<td>出院时间</td>
					<td width="60%"><input style="width: 100%; height: 100%"
						type="text" name="endTime" value="${bean.endTime }" 
				...
				<tr>
					<td>住院总费用</td>
					<td><input style="width: 100%; height: 100%" type="text"
						name="fei" value="${bean.fei }" /></td>
				</tr>
				<tr>
					<td>新农合报销</td>
					<td><input style="width: 100%; height: 100%" type="text"
						name="baoNong" value="${bean.baoNong }" /></td>
				</tr>
				<tr>
					<td>扶贫报销</td>
					<td><input style="width: 100%; height: 100%" type="text"
						name="baoPoor" value="${bean.baoPoor }" /></td>
				</tr>
				<tr>
					<td>大病报销</td>
					<td><input style="width: 100%; height: 100%" type="text"
						name="baoBigsick" value="${bean.baoBigsick }" /></td>
				</tr>
				<tr>
					<td>备注</td>
					<td><input style="width: 100%; height: 100%" type="text"
